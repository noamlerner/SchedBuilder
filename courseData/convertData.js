...
Object.keys(data).forEach(function(major) {
    var courses = [];
    var maj = data[major];
    if (maj.classes) { // deals with weird data sometimes returns.
        maj.ident = major;
...
fs.writeFileSync('./courseData/coursesModule.js', '/*convenience file created by converdata.js for easy import of coursedata*/\nmodule.exports=' + JSON.stringify(newData));